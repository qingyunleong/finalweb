            ...
            <div class="w3-padding">
                ...
                <form action="{{route('login.post')}}" method="post" accept-charset="UTF-8">
                    ...
                    <div class="w3-row">
                        ...
                        <button class="w3-button w3-round w3-border w3-right" style="background-color: #133764 ; color:white">Login</button>
                    </div>

                </form>
                <p>No Have Account? <a href="{{ url('registration') }}"><u>Sign up here.</u></a>
            </div>
        </div>
